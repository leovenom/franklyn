...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Franchising CodeKids: programação para crianças. Investimento € 30–40k, 3 unidades próprias, currículo modular e portal EAD.",
      ...
      <main id="main-content">
        ...
        <section className="px-6 py-20 md:py-28">
          <div className="mx-auto max-w-5xl text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-indigo-600">
              Expansão 2026 · Portugal continental
            </p>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <ul className="mt-12 grid gap-6 md:grid-cols-2">
              {[
                ...
                "Demanda STEM sub-atendida: concelhos 50k+ habitantes",
        ...
        <section id="investimento" className="px-6 py-20">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-4 text-center text-slate-600">Valores em euro (€)</p>
            <div className="mt-10 overflow-hidden rounded-2xl border border-indigo-100 bg-white shadow-sm">
              <table className="w-full text-sm">
                <tbody className="divide-y divide-indigo-50">
                  <tr>
                    <td className="px-6 py-4 text-slate-600">Taxa de franchising</td>
            ...
            <p className="mt-6 text-center text-xs text-slate-400">
              Território exclusivo · 1 concelho ou raio 15 km · Contrato 10 anos
            </p>
          </div>
        </section>
        ...
        <section className="border-t border-indigo-100 bg-slate-50 px-6 py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                "Manual do franchisee + 15 SOPs",
                "Formação 40h presencial + EAD",
        ...
        <section id="contato" className="px-6 py-20">
          <div className="mx-auto max-w-xl rounded-2xl border border-indigo-200 bg-white p-8 text-center shadow-lg">
            <h2 className="text-2xl font-bold">Candidate-se ao franchising</h2>
            <p className="mt-3 text-sm text-slate-600">
              Preencha o formulário. Retorno em até 48h úteis. Dossier APF entregue 15 dias antes da assinatura.
            </p>
