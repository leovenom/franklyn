...
export const metadata: Metadata = buildMetadata({
  title: "Modelo de escala de franquias — 4 ondas (Brasil)",
  description:
    "Como escalar franquia no Brasil: piloto, regional, nacional e internacional. Gates, KPIs e anti-padrões — metodologia Franklyn.",
  keywords: [
    "como escalar franquia",
    "expansão franquias Brasil",
    "primeiro franqueado",
    "master franchise Brasil",
  ],
  path: "/br/guia/modelo-escala",
  market: "br",
});

export default function BrModeloEscalaPage() {
  return (
    <PageLayout
      market="br"
      title="Modelo de escala — 4 ondas"
      description="Do diagnóstico à rede nacional. Gates de go/no-go em cada fase — foco Brasil."
      breadcrumbs={[
        { label: "Guia", href: "/br/guia/modelo-escala" },
        { label: "Modelo de escala", href: "/br/guia/modelo-escala" },
      ]}
    >
      <p>
      ...
      <ul>
        <li><strong>≥ 49/70</strong> — Franquear (Onda 0+)</li>
        <li><strong>35–48</strong> — Ajustar antes (pivot, 2ª unidade, docs)</li>
        <li><strong>&lt; 35</strong> — Não franquear (licenciamento ou esperar)</li>
      </ul>

      <h2>Onda 0 — Fundação (semanas 1–14)</h2>
      <p>Rede franqueável no papel + captação pronta.</p>
      <ul>
        <li>COF Lei 13.966</li>
        <li>Manual + 15 SOPs · modelo financeiro em R$</li>
        <li>Landing captação · CRM · EAD franqueado</li>
        <li>Mapa exclusividade v1</li>
      </ul>
      <p>
        <strong>Pacote</strong>: Growth R$ 150.000 · Gate: COF revisada por advogado.
      </p>

      <h2>Onda 1 — Piloto (meses 4–9)</h2>
      <p>1–3 franqueados validam sem fundador na operação.</p>
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-franklyn-border">
            ...
            <tr><td className="py-2 pr-4">NPS franqueados</td><td className="py-2">≥ 50</td></tr>
      ...
      <ul>
        <li><strong>Unit</strong>: 1 franqueado / município 50k+ hab.</li>
        <li><strong>Multi-unit</strong>: mesmo operador 2–3 territórios</li>
        <li><strong>Master state</strong>: 1 master / UF (SP, MG, PR primeiro)</li>
      </ul>
      <p>Gate: 8+ unidades · churn &lt; 5%/ano · royalties cobrem franqueadora.</p>

      <h2>Onda 3 — Nacional (meses 25–48)</h2>
      <p>Meta 20–50 unidades. Franqueadora self-sustaining.</p>
      <ul>
        <li>Mix receita: taxas 40–50% · royalties 35–45%</li>
        <li>Equipe rede: qualidade, expansão, marketing central, tech</li>
        <li><strong>Pacote Scale</strong>: R$ 250.000 · portal franqueado · retainer 12m</li>
      </ul>

      <h2>Anti-padrões</h2>
      <ul>
        <li>COF antes de score ≥ 49 → rede frágil</li>
        <li>Captação sem piloto → franqueados despreparados</li>
